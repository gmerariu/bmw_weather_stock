...
static void window_load(Window *window) {
  ...
  image_BMW = gbitmap_create_with_resource(RESOURCE_ID_BMW_BK);
 ...
 //Create bluetooth pic 
  ...
  text_date_layer = text_layer_create(GRect(27, 80, 50, 30));
  ...
  text_stock_layer = text_layer_create(GRect(47,127, 50, 22));
  text_layer_set_text_alignment(text_stock_layer, GTextAlignmentCenter);
  text_layer_set_text_color(text_stock_layer, GColorBlack);
